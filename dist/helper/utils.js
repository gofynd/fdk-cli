...
var transformRequestOptions = function (params) {
    ...
    var _loop_1 = function (key) {
        if (typeof params[key] !== 'object' && params[key]) {
            ...
            options += exports.transformRequestOptions(params[key]);
        }
    };
...
var getActiveContext = function () {
    if (exports.isAThemeDirectory() && exports.hasContext()) {
        var contextData = fs_extra_1.default.readJSONSync(CONTEXT_PATH());
        if (!contextData)
            throw new CommandError_1.default(CommandError_1.ErrorCodes.INVALID_CONTEXT.message + ".\n" + Logger_1.COMMON_LOG_MESSAGES.ContextNotSet, CommandError_1.ErrorCodes.INVALID_CONTEXT.code);
...
var createContext = function (context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                if (!exports.isAThemeDirectory())
                    file_utils_1.createDirectory(FDK_PATH());
                if (!exports.hasContext()) {
