...
function getFullLocalUrl(host) {
    return "".concat(getLocalBaseUrl(host), ":").concat(port);
}
...
function createTunnel() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, localtunnel_1.default)({ port: port, local_https: true, allow_invalid_cert: true })];
                case 1:
                    tunnel = _a.sent();
                    Logger_1.default.success("Tunnelled at -- ".concat(tunnel.url));
                    reload();
                    return [2 /*return*/];
            }
        });
...
function getPort(port) {
    return (0, detect_port_1.default)(port);
}
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    port = _b.sent();
                    if (port !== serverPort)
                        Logger_1.default.warn(chalk_1.default.bold.yellowBright("PORT: ".concat(serverPort, " is busy, Switching to PORT: ").concat(port)));
                    return [3 /*break*/, 3];
                case 2:
                    e_2 = _b.sent();
                ...
                case 6:
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, axios_1.default.get((0, url_join_1.default)(domain, 'public', req.url))];
                                case 1:
                                    networkRes = _a.sent();
                    ...
                    //   }
                    // }));
                    app.use("/api", (0, express_http_proxy_1.default)("".concat(host)));
                            ...
                            switch (_b.label) {
                                case 0:
                                    if (req.originalUrl == '/themeBundle.common.js') {
                                        return [2 /*return*/, res.sendFile(path_1.default.resolve(process.cwd(), "".concat(BUILD_FOLDER, "/themeBundle.common.js")))];
                                    }
                                    if (req.originalUrl == '/favicon.ico' || req.originalUrl == '/.webp') {
                                        return [2 /*return*/, res.status(404).send('Not found')];
                                    }
                                    console.log(req.hostname, req.url);
                                    jetfireUrl = new URL((0, url_join_1.default)(domain, req.originalUrl));
                                ...
                                case 5:
                                    ...
                                    $('#theme-umd-js').attr('src', (0, url_join_1.default)(getFullLocalUrl(host), 'themeBundle.umd.js'));
                                    $('#theme-umd-js-link').attr('href', (0, url_join_1.default)(getFullLocalUrl(host), 'themeBundle.umd.js'));
                                    $('#theme-css').attr('href', (0, url_join_1.default)(getFullLocalUrl(host), 'themeBundle.css'));
                                ...
                                case 10:
                                    ...
                                    errorString_1 = "<h3><b>".concat(errorString_1, "</b></h3>");
                                    mapContent = JSON.parse(fs_1.default.readFileSync("".concat(BUILD_FOLDER, "/themeBundle.common.js.map"), { encoding: 'utf8', flag: 'r' }));
                                    return [4 /*yield*/, new source_map_1.SourceMapConsumer(mapContent)];
                                case 11:
                                    smc_1 = _b.sent();
                                    stack = (0, stacktrace_parser_1.parse)(e_3.response.data);
                                    stack === null || stack === void 0 ? void 0 : stack.forEach(function (_a) {
                                        ...
                                        try {
                                            if (lineNumber == null || lineNumber < 1) {
                                                errorString_1 += "<p>      at  <strong>".concat(methodName || '', "</strong></p>");
                                            }
                                            else {
                                                var pos = smc_1.originalPositionFor({ line: lineNumber, column: column });
                                                if (pos && pos.line != null) {
                                                    errorString_1 += "<p>      at  <strong>".concat(methodName || pos.name || '', "</strong> (").concat(pos.source, ":").concat(pos.line, ":").concat(pos.column, ")</p>");
                                                }
                                            }
                                        }
                                        catch (err) {
                                    ...
                                    res.send("<div style=\"padding: 10px;background: #efe2e0;color: #af2626;\">".concat(errorString_1, "</div>"));
                                    return [3 /*break*/, 13];
                                case 12:
                                    e_4 = _b.sent();
                                    console.log(e_4);
                    ...
                    return [4 /*yield*/, new Promise(function (resolve, reject) {
                            ...
                            server.listen(port, function (err) {
                                ...
                                Logger_1.default.success("Starting server on port -- ".concat(port));
                                if (isSSR) {
