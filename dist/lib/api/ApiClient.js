    ...
    head: function (url, opt) {
        ...
        return axios_1.default.head(url, {
            ...
            paramsSerializer: function (params) {
                return utils_1.transformRequestOptions(params);
            },
        });
    },
...
axios_1.default.interceptors.response.use(function (response) {
    var _a, _b;
    Debug_1.default('************** CURL **************');
    Debug_1.default("METHOD: " + ((_a = response === null || response === void 0 ? void 0 : response.config) === null || _a === void 0 ? void 0 : _a.method) + " | PATH: " + ((_b = response === null || response === void 0 ? void 0 : response.request) === null || _b === void 0 ? void 0 : _b.path) + " | CODE: " + (response === null || response === void 0 ? void 0 : response.status));
    //log curl request incase of debug
    var curl = new curl_1.default(response.config);
    Debug_1.default(curl.generateCommand());
    Debug_1.default('************** END OF CURL **************');
    Debug_1.default('\n');
    return response;
}, function (error) {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j;
    Debug_1.default('************** CURL **************');
    Debug_1.default("METHOD: " + ((_a = error === null || error === void 0 ? void 0 : error.config) === null || _a === void 0 ? void 0 : _a.method) + " | PATH: " + ((_b = error === null || error === void 0 ? void 0 : error.request) === null || _b === void 0 ? void 0 : _b.path) + " | CODE: " + ((_c = error === null || error === void 0 ? void 0 : error.response) === null || _c === void 0 ? void 0 : _c.status));
    //log curl request incase of debug
