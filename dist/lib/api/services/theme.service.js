...
exports.default = {
        ...
        return __generator(this, function (_a) {
            try {
                axiosOption = Object.assign({}, {
                    data: data,
                }, (0, utils_2.getCommonHeaderOptions)());
    ...
    getThemeById: function (data) {
        try {
            var activeContext = data ? data : (0, utils_1.getActiveContext)();
            var axiosOption = Object.assign({}, (0, utils_2.getCommonHeaderOptions)());
    ...
    updateTheme: function (data) {
        try {
            var activeContext = (0, utils_1.getActiveContext)();
