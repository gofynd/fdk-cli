...
var Theme = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.sent();
                        Logger_1.default.success("".concat(path.split('/').slice(-1)[0], " written succesfully.!!!"));
                        return [3 /*break*/, 3];
                    case 2:
                        err_1 = _b.sent();
                        throw new CommandError_1.default("Error writing ".concat(path.split('/').slice(-1)[0], " file.!!!"));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        settingsJson = _b.sent();
                        Logger_1.default.success("".concat(path.split('/').slice(-1)[0], " read successfully.!!!"));
                        return [2 /*return*/, settingsJson];
                    case 2:
                        err_2 = _b.sent();
                        throw new CommandError_1.default("Error reading ".concat(path.split('/').slice(-1)[0], " file.!!!"));
                    case 3: return [2 /*return*/];
                }
            });
        });
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (fs_extra_1.default.existsSync(targetDirectory)) {
                            shouldDelete = false;
                            throw new CommandError_1.default("Folder ".concat(options.name, " already exists"));
                        }
                        Logger_1.default.warn('Validating token');
                        configObj = JSON.parse((0, utils_1.decodeBase64)(options.token) || '{}');
                        (0, Debug_1.default)("Token Data: ".concat(JSON.stringify(configObj)));
                        if (!configObj)
                        ...
                        (0, Debug_1.default)("Token expires in: ".concat(configObj.expires_in));
                    ...
                    case 5:
                        ...
                        process.chdir("./".concat(options.name));
                        Logger_1.default.warn('Saving context');
                        return [4 /*yield*/, (0, utils_1.createContext)(context)];
                    case 6:
                        _b.sent();
                    ...
                    case 7:
                        _b.sent();
                        return [4 /*yield*/, fs_extra_1.default.readJSON("".concat(process.cwd(), "/package.json"))];
                    case 8:
                        packageJSON = _b.sent();
                        packageJSON.name = Theme.sanitizeThemeName(options.name);
                        return [4 /*yield*/, fs_extra_1.default.writeJSON("".concat(process.cwd(), "/package.json"), packageJSON, {
                                spaces: 2,
                            })];
                    case 9:
                        _b.sent();
                    ...
                    case 10:
                        _b.sent();
                        b5 = (0, boxen_1.default)(chalk_1.default.green.bold('DONE ') +
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 3, , 4]);
                        (0, file_utils_1.createDirectory)(targetDirectory);
                        return [4 /*yield*/, fs_extra_1.default.copy(templateDirectory, targetDirectory)];
                    case 1:
                        _b.sent();
                        return [4 /*yield*/, (0, execa_1.default)('git', ['init'], { cwd: targetDirectory })];
                    case 2:
                        _b.sent();
                        (0, file_utils_1.writeFile)(targetDirectory + '/.gitignore', ".fdk\nnode_modules");
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        var exec = (0, execa_1.default)('npm', ['i'], { cwd: process.cwd() });
            ...
            return __generator(this, function (_b) {
                ...
                pArr = sectionsFiles.map(function (f) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                image_section = vue_template_compiler_1.default.parseComponent((0, file_utils_1.readFile)(path_1.default.join(Theme.TEMPLATE_DIRECTORY, 'sections', f)));
                                return [4 /*yield*/, new Promise(function (resolve, reject) {
                                        require('@babel/core').transform(image_section.script.content, {
                                            ...
                                            try {
                                                var modules = (0, require_from_string_1.default)(result.code);
    ...
    Theme.getAvailableSectionsForSync = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                sectionsFiles = fs_extra_1.default
                    .readdirSync("".concat(process.cwd(), "/theme/sections"))
                    .filter(function (o) { return o != 'index.js'; });
                settings = sectionsFiles.map(function (f) {
                    return Theme.extractSettingsFromFile("".concat(process.cwd(), "/theme/sections/").concat(f));
                });
    ...
    Theme.extractSettingsFromFile = function (path) {
        var $ = cheerio_1.default.load((0, file_utils_1.readFile)(path));
    ...
    Theme.validateSections = function (available_sections) {
        ...
        available_sections.forEach(function (section, index) {
            if (!fileNameRegex.test(section.name)) {
                throw new Error("Invalid section name, ".concat(section.name));
            }
            if (sectionNamesObject["".concat(section.name)]) {
                throw new Error("Duplication section name found. ".concat(section.name));
            }
            sectionNamesObject["".concat(section.name)] = true;
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                fileNames = fs_extra_1.default
                    .readdirSync("".concat(process.cwd(), "/theme/sections"))
                    .filter(function (o) { return o != 'index.js'; });
                template = "\n            ".concat(fileNames.map(function (f, i) { return "import * as component".concat(i, " from './").concat(f, "';"); }).join('\n'), "\n\n            function exportComponents(components) {\n            return [\n                ").concat(available_sections
                    .map(function (s, i) {
                    return JSON.stringify({
                        name: s.name,
                        label: s.label,
                        component: '',
                    }).replace('"component":""', "\"component\": components[".concat(i, "].default"));
                })
                    .join(',\n'), "\n            ];\n            }\n\n            export default exportComponents([").concat(fileNames
                    .map(function (f, i) { return "component".concat(i); })
                    .join(','), "]);\n            ");
                rimraf_1.default.sync("".concat(process.cwd(), "/theme/sections/index.js"));
                fs_extra_1.default.writeFileSync("".concat(process.cwd(), "/theme/sections/index.js"), template);
                return [2 /*return*/];
            });
        });
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!fs_extra_1.default.existsSync("".concat(targetDirectory, "/.fdk/context.json"))) return [3 /*break*/, 3];
                        return [4 /*yield*/, fs_extra_1.default.readJSON("".concat(targetDirectory, "/.fdk/context.json"))];
                    case 1:
                        contexts = _b.sent();
    ...
    */
        ...
        return __generator(_a, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, configuration_service_1.default.getApplicationDetails(configObj)];
                case 2:
                    appConfig = (_c.sent()).data;
                    Logger_1.default.warn('Fetching Template Files');
                    return [4 /*yield*/, theme_service_1.default.getThemeById(configObj)];
                case 3:
                    themeData = (_c.sent()).data;
                    themeName = ((_b = themeData === null || themeData === void 0 ? void 0 : themeData.information) === null || _b === void 0 ? void 0 : _b.name) || 'default';
                    targetDirectory = path_1.default.join(process.cwd(), themeName);
                    if (fs_extra_1.default.existsSync(targetDirectory)) {
                        shouldDelete = false;
                        throw new CommandError_1.default("Folder ".concat(themeName, "  already exists"));
                    }
                    Logger_1.default.warn('Copying template files');
                    shouldDelete = true;
                    return [4 /*yield*/, Theme.copyTemplateFiles(Theme.TEMPLATE_DIRECTORY, targetDirectory)];
                case 4:
                    ...
                    process.chdir("./".concat(themeName));
                    zipPath = path_1.default.join(targetDirectory, '.fdk/archive/archive.zip');
                    Logger_1.default.warn('Downloading bundle files');
                    return [4 /*yield*/, (0, download_1.downloadFile)(themeData.src.link, zipPath)];
                case 5:
                    _c.sent();
                    return [4 /*yield*/, (0, archive_1.extractArchive)({ zipPath: zipPath, destFolderPath: path_1.default.resolve(process.cwd(), 'theme') })];
                case 6:
                    _c.sent();
                ...
                case 9:
                    ...
                    if (fs_extra_1.default.existsSync(process.cwd() + '/theme/package.json')) {
                        (0, file_utils_1.writeFile)(process.cwd() + '/package.json', fs_extra_1.default.readFileSync(process.cwd() + '/theme/package.json'));
    ...
    Theme.syncTheme = function (isNew) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var currentContext, env, theme, newConfig_1, oldConfig, questions, themeContent, available_sections, imageCdnUrl, assetCdnUrl, startData, startAssetData, startData, startAssetData, androidImages, iosImages, desktopImages, thumbnailImages, androidImageFolder, pArr, iosImageFolder, desktopImageFolder, thumbnailImageFolder, cwd, images, cwd, fonts, zipFilePath, srcCdnUrl, res, urlHash_1, assets, pArr, _b, cssUrl, commonJsUrl, umdJsUrl, packageJSON, globalConfigSchema, globalConfigData, pageTemplateFiles, availablePages_1, error_5;
            return __generator(_a, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 27, , 28]);
                        currentContext = (0, utils_1.getActiveContext)();
                    ...
                    case 4:
                        ...
                        themeContent = (0, file_utils_1.readFile)("".concat(process.cwd(), "/config.json"));
                        try {
                    ...
                    case 9:
                        ...
                        // build js css
                        return [4 /*yield*/, (0, build_1.build)({ buildFolder: Theme.BUILD_FOLDER, imageCdnUrl: imageCdnUrl, assetCdnUrl: assetCdnUrl })];
                    case 10:
                        // build js css
                        _c.sent();
                    ...
                    case 14:
                        ...
                        return [4 /*yield*/, (0, utils_1.asyncForEach)(images, function (img) { return __awaiter(void 0, void 0, void 0, function () {
                                var assetPath;
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0:
                    ...
                    case 15:
                        ...
                        return [4 /*yield*/, (0, utils_1.asyncForEach)(fonts, function (font) { return __awaiter(void 0, void 0, void 0, function () {
                                var assetPath;
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0:
                    ...
                    case 18:
                        ...
                        return [4 /*yield*/, (0, archive_1.archiveFolder)({
                    ...
                    case 20:
                        ...
                        pArr = assets.map(function (asset) { return __awaiter(void 0, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        fs_extra_1.default.renameSync(path_1.default.join(Theme.BUILD_FOLDER, asset), "".concat(Theme.BUILD_FOLDER, "/").concat(urlHash_1, "-").concat(asset));
                                        assetPath = path_1.default.join(Theme.BUILD_FOLDER, "".concat(urlHash_1, "-").concat(asset));
                                        return [4 /*yield*/, upload_service_1.default.uploadFile(assetPath, 'application-theme-assets')];
                                    case 1:
                                        res = _b.sent();
                                        return [2 /*return*/, res.start.cdn.url];
                        ...
                        return [4 /*yield*/, Promise.all(pArr)];
                    case 21:
                        _b = _c.sent(), cssUrl = _b[0], commonJsUrl = _b[1], umdJsUrl = _b[2];
                        packageJSON = JSON.parse((0, file_utils_1.readFile)("".concat(process.cwd(), "/package.json")));
                        if (!packageJSON.name) {
                    ...
                    case 22:
                        globalConfigSchema = _c.sent();
                        return [4 /*yield*/, Theme.readSettingsJson(Theme.getSettingsDataPath())];
                    case 23:
                        globalConfigData = _c.sent();
                        ...
                        pageTemplateFiles = fs_extra_1.default
                            .readdirSync("".concat(process.cwd(), "/theme/templates/pages"))
                            .filter(function (o) { return o != 'index.js'; });
                        theme.config = theme.config || {};
                        availablePages_1 = [];
                        return [4 /*yield*/, (0, utils_1.asyncForEach)(pageTemplateFiles, function (fileName) { return __awaiter(void 0, void 0, void 0, function () {
                                    ...
                                    switch (_b.label) {
                                        ...
                                        case 4:
                                            ...
                                            pageData = {
                                                ...
                                                sections_meta: [],
                                                type: 'system',
                                                text: (0, utils_1.pageNameModifier)(pageName),
                                            };
                                        ...
                                        case 6:
                                            available_page.props =
                                                (Theme.extractSettingsFromFile("".concat(process.cwd(), "/theme/templates/pages/").concat(fileName)) || {}).props || [];
                                            available_page.sections_meta = Theme.extractSectionsFromFile("".concat(process.cwd(), "/theme/templates/pages/").concat(fileName));
                    ...
                    case 25:
                        ...
                        return [4 /*yield*/, (0, utils_1.asyncForEach)(availablePages_1, function (page) { return __awaiter(void 0, void 0, void 0, function () {
                                var error_7;
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0:
    ...
    Theme.serveTheme = function (options) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(_a, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    appInfo = (_b.sent()).data;
                    domain = Array.isArray(appInfo.domains)
                        ? "https://".concat(appInfo.domains.filter(function (d) { return d.is_primary; })[0].name)
                        : "https://".concat(appInfo.domain.name);
                    host_1 = url_1.BASE_URL;
                    // initial build
                    Logger_1.default.success("Locally building............");
                    return [4 /*yield*/, (0, build_1.devBuild)({
                            buildFolder: Theme.BUILD_FOLDER,
                            imageCdnUrl: (0, url_join_1.default)((0, serve_utils_1.getFullLocalUrl)(host_1), 'assets/images'),
                            isProd: isSSR_1,
                        })];
                case 2:
                    _b.sent();
                    ...
                    return [4 /*yield*/, (0, serve_utils_1.startServer)({ domain: domain, host: host_1, isSSR: isSSR_1, serverPort: serverPort })];
                case 3:
                    _b.sent();
                    // open browser
                    return [4 /*yield*/, (0, open_1.default)((0, serve_utils_1.getFullLocalUrl)(host_1))];
                case 4:
                    // open browser
                    _b.sent();
    ...
    Theme.pullTheme = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(_a, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 9, , 10]);
                    spinner = (0, ora_1.default)('Pulling theme data').start();
                    rimraf_1.default.sync(path_1.default.resolve(process.cwd(), './theme'));
                    (0, file_utils_1.createDirectory)('theme');
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, download_1.downloadFile)(theme.src.link, './.fdk/pull-archive.zip')];
                case 2:
                    _b.sent();
                    return [4 /*yield*/, (0, archive_1.extractArchive)({
    ...
    Theme.publishTheme = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(_a, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    spinner = (0, ora_1.default)('Publishing theme').start();
    ...
    Theme.unPublishTheme = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(_a, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    spinner = (0, ora_1.default)('Unpublishing theme').start();
