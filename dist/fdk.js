...
var utils_2 = require("./helper/utils");
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    (0, Logger_2.initializeLogger)();
                                    return [4 /*yield*/, checkCliVersionAsync()];
                                case 1:
                                    latest = _a.sent();
                                    (0, Debug_1.default)("Latest version: ".concat(latest, " | ").concat(semver_1.default.lt(packageJSON.version, latest)));
                                    versionChange = semver_1.default.diff(packageJSON.version, latest);
                                    major = versionChange === 'major';
                                    color = major ? 'red' : 'green';
                                    logMessage = "There is a new version of ".concat(packageJSON.name, " available (").concat(latest, ").\nYou are currently using ").concat(packageJSON.name, " ").concat(packageJSON.version, ".\nInstall fdk-cli globally using the package manager of your choice.\n").concat(major ? "\nNote: You need to update `".concat(packageJSON.name, "` first inorder to use it.") : '', "\nRun `npm install -g ").concat(packageJSON.name, "` to get the latest version.");
                                    if (latest && semver_1.default.lt(packageJSON.version, latest)) {
                                        console.log((0, boxen_1.default)(major ? chalk_1.default.red(logMessage) : chalk_1.default.green(logMessage), { borderColor: color, padding: 1 }));
                                    ...
                                    if (constants_1.THEME_COMMANDS.findIndex(function (c) { return themeCommand_1.includes(c); }) !== -1) {
                                        activeContextEnv = (0, utils_2.getActiveContext)().env;
                                    ...
                                    if (!!(0, utils_1.isAThemeDirectory)()) return [3 /*break*/, 3];
                                ...
                                case 5:
                                    ...
                                    if (err_1 instanceof CommandError_1.default) {
                                        message = "".concat(err_1.code, " - ").concat(err_1.message, " ");
                                        Logger_1.default.error(message);
                                    }
                                    else {
                                        Logger_1.default.error(err_1);
                                    }
                                    (0, Debug_1.default)(err_1.stack);
                                    process.exit(1);
                                    return [3 /*break*/, 6];
...
function init(programName) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            (0, commands_1.registerCommands)(commander_1.default);
            //set API versios
            Config_1.default.set(Config_1.CONFIG_KEYS.API_VERSION, '1.0');
            // set default environment
            if (!Config_1.default.get(Config_1.CONFIG_KEYS.CURRENT_ENV_VALUE))
                Config_1.default.set(Config_1.CONFIG_KEYS.CURRENT_ENV_VALUE, 'fynd');
            commander_1.default.on('command:*', function (subCommand) {
                var msg = "\"".concat(subCommand.join(' '), "\" is not an fdk command. See \"fdk --help\" for the full list of commands.");
                ...
                var suggestion = availableCommands.find(function (commandName) { return (0, leven_1.default)(commandName, subCommand[0]) < commandName.length * 0.4; });
                if (suggestion) {
                    msg = "\"".concat(subCommand, "\" is not an fdk command -- did you mean ").concat(suggestion, "?\n See \"fdk --help\" for the full list of commands.");
                }
...
function checkCliVersionAsync() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, latest_version_1.default)(packageJSON.name)];
