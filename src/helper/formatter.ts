...
export const successBox = ({ text }) => boxen(chalk.bold.green(`${text}`), {
  padding: 2,
  margin: 2,
  textAlignment: 'left',
});

export const errorBox = ({ text }) => boxen(chalk.bold.red(`${text}`), {
  padding: 2,
  margin: 2,
  textAlignment: 'left',
});

export const warningBox = ({ text }) => boxen(chalk.bold.yellow(`${text}`), {
  padding: 2,
  margin: 2,
  textAlignment: 'left',
});
